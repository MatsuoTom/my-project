...
def __getattr__(name: str):
    # math_utils
    if name in ["calculate_compound_interest", "calculate_present_value",
                "calculate_annuity_present_value", "calculate_annuity_future_value",
                "calculate_irr", "calculate_npv"]:
    ...
    # date_utils
    elif name in ["calculate_age", "calculate_years_between",
                  "to_wareki", "from_wareki"]:
