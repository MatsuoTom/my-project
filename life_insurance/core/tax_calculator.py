...
def main():
    ...
    for income in test_incomes:
        ...
        print(f"課税所得: {income:,}円 → 所得税: {tax_info['合計所得税']:,.0f}円 "
    ...
    for income in test_incomes:
        ...
        print(f"課税所得: {income:,}円 → 節税額: {savings['合計節税額']:,.0f}円 "
    ...
    print(simulation[["所得変動", "課税所得", "所得税率", "合計節税額", "実効節税率"]].to_string(index=False))
